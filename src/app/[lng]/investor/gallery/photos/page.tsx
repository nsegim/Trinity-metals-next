    ...
    <>
      ...
      <div className="custom-hero photo-gallery">
        <div className="child-item-wrapper z-1">
          <h1 className="heading text-uppercase">{dict.gallery["photos"]}</h1>
        </div>
      </div>
      ...
      <div className="gallery-navigation">
        <div className="gallery-nav-wrapper d-flex">
          <a href={`/${lang}/investor/gallery/photos`} className="gallery-nav visited">
          ...
          <a href={`/${lang}/investor/gallery/videos`} className="gallery-nav">
